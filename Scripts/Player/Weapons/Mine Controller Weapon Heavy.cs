...
public class MineControllerWeaponHeavy : MonoBehaviour
{
    ...
    void Update()
    {
        MineSpeed = StatsController.MineHeavySpeed;
        Damage = StatsController.MineHeavyDamage;
        fireDelay = StatsController.MineHeavyFireDelay;
        ExplosionRadius = StatsController.MineHeavyExplosionRadius;
        if (canFire == true && StaminaRegen.isReloading == false)
        {
            ...
            if (StatsController.DoubleShot)
            {
                ...
                if (Skill.usingMainWeaponMineHeavy == true || Skill.usingBackupWeaponMineHeavy == true)
                {
                    FireMissile();
                    firedFirstMine = true;
                    setDelayTimer = 0f;
